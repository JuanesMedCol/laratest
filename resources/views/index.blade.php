...
<body class="bg-gray-100 text-grey-700">
    ...
    <div class="container mx-auto px-4">
        <div class="mb-10">
            <?php
            $curl = curl_init();
            $httpheader = ['Authorization: Bearer ChangeThisTextForApiKey'];
            $url = "https://iudigital.test.instructure.com:443/api/v1/courses/2222/users?include[]=enrollments&enrollment_state[]=active&enrollment_state[]=inactive";
